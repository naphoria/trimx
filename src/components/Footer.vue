    ...
    <footer>
        ...
        <div class="w-full mx-auto rounded-xl bg-gray-100 shadow-lg p-10 text-gray-800 relative overflow-hidden resize-x min-w-80 max-w-3xl" x-data="app()" x-init="generatePassword()">
            <div class="relative mt-1">
                <h2 class="font-bold mb-5 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 sm:text-4xl sm:leading-10">Your thoughts</h2>

                <p>Tell us what you think.</p>
                <div class="container mx-auto px-6 my-1 flex flex-wrap -m-4">
                ...
                <input type="text" id="name" class="w-full pl-3 pr-10 py-2 border-2 border-gray-200 rounded-xl hover:border-gray-300 focus:outline-none focus:border-blue-500 transition-colors mb-4" placeholder="Name*">
                <input type="message" id="message" class="w-full pl-3 pr-10 py-2 border-2 border-gray-200 rounded-xl hover:border-gray-300 focus:outline-none focus:border-blue-500 transition-colors mb-4" placeholder="message*">
                <button @click="findBarber" class="bg-gray-800 text-white w-full px-6 py-3 border-2 border-gray-200 rounded-xl hover:border-gray-300 focus:outline-none focus:border-blue-500 transition-colors">Get Barber ETA</button>
            </div>
        </div>
    </div>
    </footer>
